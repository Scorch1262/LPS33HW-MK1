...
# 99 "main.c"
    ...
    while (1){
        ...
        I2C_Write1ByteRegister(0x5C,0x11, 0b00000001);
        tempDataH = I2C_Read1ByteRegister(0x5C,0x2C);
        tempDataL = I2C_Read1ByteRegister(0x5C,0x2B);
        tempData = tempDataH | (tempDataL << 8);
        tempDataAnz = tempData / 1000.0f;
        printf("%4.2f °C\r\n",tempDataAnz);


        I2C_Write1ByteRegister(0x5C,0x11, 0b00000001);
        pressDataXL = I2C_Read1ByteRegister(0x5C,0x28);
        pressDataL = I2C_Read1ByteRegister(0x5C,0x29);
        pressDataH = I2C_Read1ByteRegister(0x5C,0x2A);
